...
let MaterialsController = class MaterialsController {
    ...
    findAll(jewelryType, category, technique, hasTrialPack) {
...
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('jewelryType')),
    __param(1, (0, common_1.Query)('category')),
    __param(2, (0, common_1.Query)('technique')),
    __param(3, (0, common_1.Query)('hasTrialPack')),
...
__decorate([
    (0, common_1.Get)('filters/techniques'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], MaterialsController.prototype, "getTechniques", null);
